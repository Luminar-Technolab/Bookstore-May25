...
function Edit() {
  ...
  return (
    <div>
      ...
      { offCanvasStatus &&
        <div>
        <div className="fixed inset-0 bg-gray-500/75 w-full h-full" onClick={()=>setOffCanvasStatus(false)}>
        </div>
        <div className="bg-white h-full w-90 z-50 fixed top-0 left-0">
          ...
          <div className="flex justify-center items-center flex-col my-5">
            ...
            <div className="mb-3 w-full px-5">
              <textarea value={userDetails.bio} onChange={e=>setUserDetails({...userDetails,bio:e.target.value})} placeholder='Bio' className="w-full border border-gray-300 placeholder-gray-200 p-2 rounded"></textarea>
            </div>
